      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 animate-in fade-in">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-5">
            ...
            <StatCard title="Progress" value={inProg} color="indigo" icon={<Zap size={24}/>} onClick={() => handleStatClick('Progress')}/>
            <StatCard title="Drafts" value={draft} color="purple" icon={<Paperclip size={24}/>} onClick={() => handleStatClick('Drfts')}/>
